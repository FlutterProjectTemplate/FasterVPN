...
ThemeData customLightTheme(
  ...
  return ThemeData(
      ...
      dividerColor: Colors.grey, textSelectionTheme: TextSelectionThemeData(cursorColor: Color.fromRGBO(37,112,252, 1)));
}
...
ThemeData customDarkTheme(
  ...
  return ThemeData(
      ...
      dividerColor: Colors.white.withOpacity(.6), textSelectionTheme: TextSelectionThemeData(cursorColor: Color.fromRGBO(105, 73, 199, 1)));
}
